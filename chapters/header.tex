...
\documentclass [12pt,twoside,a4paper,titlepage,fleqn,openright]{report}
%\usepackage{ngerman}
...
%This prints the plural of the term associated with <label>, so \glspl{oesophagus} will display œsophagi. Aga%in, the text will be a hyperlink to the relevant entry in the glossary, if hyperlinks are defined.
